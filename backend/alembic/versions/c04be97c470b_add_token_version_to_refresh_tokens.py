"""add token version to refresh tokens

Revision ID: c04be97c470b
Revises: b23ff08d120b
Create Date: 2026-09-25 20:48:33.392313
...
revision: str = 'c04be97c470b'
down_revision: Union[str, Sequence[str], None] = 'b23ff08d120b'
...
def downgrade() -> None:
    ...
    sa.Column('token_family', sa.VARCHAR(length=64), autoincrement=False, nullable=False),
    sa.Column('expires_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
